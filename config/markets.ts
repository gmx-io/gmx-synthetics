...
const config: {
  ...
  arbitrum: [
    ...
    },
    {
      ...
      aboveOptimalUsageBorrowingFactorForLongs: percentageToFloat("210%").div(SECONDS_PER_YEAR),
      aboveOptimalUsageBorrowingFactorForShorts: percentageToFloat("210%").div(SECONDS_PER_YEAR),
    },
    {
