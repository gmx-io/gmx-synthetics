    ...
    arbitrum: [
      {
        ...
        markets: [
          ...
          // createGlvMarketConfig("MNT", arbitrum_ethUsdcDefaultCap, 1.0),
          // createGlvMarketConfig("SPX6900", arbitrum_ethUsdcDefaultCap, 1.0),
        ],
      },
      {
        ...
        markets: [
          ...
          createGlvMarketConfig("PUMP", arbitrum_btcUsdcDefaultCap, 1),
        ],
      },
    ],
    avalanche: [
