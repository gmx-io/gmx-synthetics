    ...
    arbitrum: [
      {
        ...
        markets: [
          ...
          {
            indexToken: "DOGE",
            glvMaxMarketTokenBalanceAmount: expandDecimals(1_900_000, 18),
          ...
          {
            indexToken: "SUI",
            glvMaxMarketTokenBalanceAmount: expandDecimals(650_000, 18),
            glvMaxMarketTokenBalanceUsd: decimalToFloat(650_000),
          },
          {
            indexToken: "SEI",
            glvMaxMarketTokenBalanceAmount: expandDecimals(400_000, 18),
