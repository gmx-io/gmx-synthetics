...
// BigNumber.from(utils.id("GLP_DISTRIBUTION")).toString()
export const GLV_V1_DISTRIBUTION_ID = "11802763389053472339483616176459046875189472617101418668457790595837638713068";
// BigNumber.from(utils.id("GLV_V1_3_MONTHS_BONUS_DISTRIBUTION_ID")).toString()
export const GLV_V1_3_MONTHS_BONUS_DISTRIBUTION_ID =
  "64013039480962942581181820133015390730044968712377073754034637994666645393343";
// BigNumber.from(utils.id("GLV_V1_BONUS_TEST_DISTRIBUTION_ID")).toString()
export const GLV_V1_BONUS_TEST_DISTRIBUTION_ID =
  "113005011054014960800824418529010340523901000236636486140352426860453188114236";
