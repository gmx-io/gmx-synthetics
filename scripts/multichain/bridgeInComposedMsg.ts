...
// ACTION_TYPE=<None/Deposit/GlvDeposit/SetTraderReferralCode/Withdrawal/GlvWithdrawal> NATIVE_TOPUP=0.01 npx hardhat run --network sepolia scripts/multichain/bridgeInComposedMsg.ts
async function main() {
