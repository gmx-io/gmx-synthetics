...
SELECT
    ...
    -- Assets summary
    ROUND(total_deposited, 4) as total_deposited_weth,
    ROUND(total_withdrawn, 4) as total_withdrawn_weth,
    ROUND(net_position, 4) as net_position_weth,
