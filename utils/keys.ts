...
export const DATA_STREAM_SPREAD_FACTOR = hashString("DATA_STREAM_SPREAD_FACTOR");
...
export function dataStreamSpreadFactorKey(token: string) {
  return hashData(["bytes32", "address"], [DATA_STREAM_SPREAD_FACTOR, token]);
}
