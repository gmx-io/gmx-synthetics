...
library PositionEventUtils {
    ...
    function _emitPositionFees(
        ...
        eventData.uintItems.initItems(31);
        ...
        eventData.uintItems.setItem(28, "liquidationFeeAmount", fees.liquidation.liquidationFeeAmount);
        eventData.uintItems.setItem(29, "liquidationFeeReceiverFactor", fees.liquidation.liquidationFeeReceiverFactor);
        eventData.uintItems.setItem(30, "liquidationFeeAmountForFeeReceiver", fees.liquidation.liquidationFeeAmountForFeeReceiver);
