...
library RelayUtils {
    ...
    bytes32 public constant BRIDGE_OUT_TYPEHASH =
        keccak256(bytes("BridgeOut(address token,uint256 amount,uint256 minAmountOut,address provider,bytes data,address bridgeFeeToken,uint256 bridgeFeeAmount,address[] bridgeFeeSwapPath,bytes32 relayParams)"));
