...
contract FeeDistributor is ReentrancyGuard, RoleModule {
    ...
    function commitSnapshot() external nonReentrant onlyFeeDistributionKeeper {
        ...
        if (
            ...
            _getUint(Keys2.feeDistributorSnapshotEpochKey(block.chainid)) == epochId
        ) {
        ...
        _setUint(Keys2.feeDistributorSnapshotFeeAmountGmxKey(block.chainid), feeAmountGmx);
        _setUint(Keys2.feeDistributorSnapshotStakedGmxKey(block.chainid), stakedGmx);
        _setUint(Keys2.feeDistributorSnapshotEpochKey(block.chainid), epochId);
        ...
        _setUint(Keys2.feeDistributorStakedGmxKey(block.chainid), stakedGmx);
    ...
    function initiateDistribute() external nonReentrant onlyFeeDistributionKeeper {
        ...
        {
            uint256 committedEpoch = _getUint(Keys2.feeDistributorSnapshotEpochKey(block.chainid));
    ...
    function resetDistribution() external nonReentrant onlyTimelockAdmin {
        ...
        _setUint(Keys2.feeDistributorSnapshotEpochKey(block.chainid), 0);
