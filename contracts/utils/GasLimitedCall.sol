...
library GasLimitedCall {
    ...
    function functionCall(address target, bytes memory data, uint256 gasLimit) internal returns (bytes memory) {
        return functionCallWithValue(target, data, 0, gasLimit, "Address: low-level call failed");
    }
    ...
    function functionCall(
        ...
        return functionCallWithValue(target, data, 0, gasLimit, errorMessage);
    }
    ...
    function functionCallWithValue(
        ...
        return functionCallWithValue(target, data, value, gasLimit, "Address: low-level call with value failed");
    }
